...
Protected Module ZipConfig
	...
	#tag Property, Flags = &h0
		#tag Note
			Attention: If you set this to true, then it'll cause trouble unpacking any zipped folders on Windows 7 - they'll appears as locked files, not folders then.
			Since hardly anyone still uses ZipIt 2.2, I suggest keeping this constant set to false all the time to avoid conflicts with more current software.
		#tag EndNote
